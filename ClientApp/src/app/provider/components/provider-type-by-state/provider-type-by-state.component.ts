...
@Component({
  selector: 'app-provider-type-by-state',
  templateUrl: './provider-type-by-state.component.html'
})
export class ProviderTypeByStateComponent implements OnInit {
...
console.log('TEST')
  ...
  goToDetail(provider)
  {
    ...
    this.router.navigate(["provider-statedetail"],  navigationExtras);
  }
